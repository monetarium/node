...
func ExampleAmount() {
	...
	// Output:
	// Zero Atom: 0 VAR
	// 100,000,000 Atoms: 1 VAR
	// 100,000 Atoms: 0.001 VAR
}
...
func ExampleAmount_unitConversions() {
	...
	// Output:
	// Atom to kCoin: 444.333222111 kVAR
	// Atom to Coin: 444333.222111 VAR
	// Atom to MilliCoin: 444333222.111 mVAR
	// Atom to MicroCoin: 444333222111 μVAR
