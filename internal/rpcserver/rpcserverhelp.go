...
var helpDescsEnUS = map[string]string{
	...
	"debuglevel--synopsis": "Dynamically changes the debug logging level.\n" +
		...
		"The valid subsystems are AMGR, ADXR, BCDB, VAR, CHAN, DISC, PEER, RPCS, SCRP, SRVR, SYNC, and TXMP.\n" +
	...
	// GetMempoolFeesInfo help.
	"getmempoolfeesinfo--synopsis":              "Returns detailed mempool fee analytics per coin type.",
	...
	"mempoolcointypefeeinfo-minfee":             "Minimum fee rate (DCR/KB).",
	"mempoolcointypefeeinfo-maxfee":             "Maximum fee rate (DCR/KB).",
	"mempoolcointypefeeinfo-averagefee":         "Average fee rate (DCR/KB).",
	"mempoolcointypefeeinfo-medianfee":          "Median fee rate (DCR/KB).",
	"mempoolcointypefeeinfo-p25fee":             "25th percentile fee rate (DCR/KB).",
	"mempoolcointypefeeinfo-p75fee":             "75th percentile fee rate (DCR/KB).",
	"mempoolcointypefeeinfo-p90fee":             "90th percentile fee rate (DCR/KB).",
	"mempoolcointypefeeinfo-totalfees":          "Total fees for all transactions (DCR).",
	"mempoolcointypefeeinfo-oldesttxtime":       "Unix timestamp of oldest transaction.",
	"mempoolcointypefeeinfo-newesttxtime":       "Unix timestamp of newest transaction.",
	"mempoolcointypefeeinfo-utilizationrate":    "Percentage of allocated block space used.",
	...
	"estimatesmartfee-cointype":      "Optional: the coin type to estimate fees for (0 for VAR, 1-255 for SKA variants). Defaults to VAR (0).",
	...
	// GetFeeEstimatesByCoinType help.
	"getfeestimatesbycointype--synopsis":     "Returns comprehensive fee estimates for a specific coin type.",
	"getfeestimatesbycointype-cointype":      "The coin type to get fee estimates for (0 for VAR, 1-255 for SKA variants).",
	"getfeestimatesbycointype-confirmations": "Estimate the fee rate for transactions to be mined in up to this number of blocks.",
	"getfeestimatesbycointype-mode":          "The fee estimation mode ('conservative' is the only supported mode).",
	"getfeeresult-cointype":                  "The coin type.",
	"getfeeresult-minrelayfee":               "The minimum relay fee.",
	"getfeeresult-dynamicfeemultiplier":      "The dynamic fee multiplier.",
	"getfeeresult-fastfee":                   "Fast fee rate.",
	"getfeeresult-normalfee":                 "Normal fee rate.",
	"getfeeresult-slowfee":                   "Slow fee rate.",
	"getfeeresult-pendingtxcount":            "Number of pending transactions.",
	"getfeeresult-pendingtxsize":             "Total size of pending transactions.",
	"getfeeresult-blockspaceused":            "Percentage of block space used.",
	"getfeeresult-lastupdated":               "Unix timestamp.",
	"getfeeresult-errors":                    "Unused.",
...
var rpcResultTypes = map[types.Method][]interface{}{
	...
	"getfeestimatesbycointype": {(*types.GetFeeResult)(nil)},
