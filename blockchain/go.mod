...
require (
	github.com/monetarium/node/blockchain/stake v1.0.2
	github.com/monetarium/node/blockchain/standalone v1.0.2
	...
	github.com/monetarium/node/txscript v1.0.2
...
require (
	...
	github.com/monetarium/node/database v1.0.2 // indirect
